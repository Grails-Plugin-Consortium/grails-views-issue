...
<body ng-app="grails.views.issue" ng-controller="IndexController as vm">
    ...
    <div id="content" role="main">
        <section class="row colset-2-its">
            ...
            <div id="persons" role="navigation">
                <h2>Persons:</h2>
                <ul ng-cloak>
                    <li ng-repeat="person in vm.persons" class="controller">
                        {{person}}
                    </li>
                </ul>
            </div>

            <div id="addresses" role="navigation">
                <h2>Addresses:</h2>
                <ul ng-cloak>
                    <li ng-repeat="address in vm.addresses" class="controller">
                        {{address}}
                    </li>
                </ul>
            </div>
    ...
    <asset:javascript src="/grails/views/issue/grails.views.issue.js" />
</body>
</html>
